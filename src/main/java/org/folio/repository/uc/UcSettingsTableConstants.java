...
public final class UcSettingsTableConstants {
  ...
  private static final String[] ALL_COLUMNS =
    new String[] {ID_COLUMN, KB_CREDENTIALS_ID_COLUMN, CUSTOMER_KEY_COLUMN, CURRENCY_COLUMN, START_MONTH_COLUMN,
                  PLATFORM_TYPE_COLUMN, CREATED_DATE_COLUMN, CREATED_BY_USER_ID_COLUMN, CREATED_BY_USER_NAME_COLUMN,
                  UPDATED_DATE_COLUMN, UPDATED_BY_USER_ID_COLUMN, UPDATED_BY_USER_NAME_COLUMN};

  private UcSettingsTableConstants() {
  }

  public static String selectUcSettingsByCredentialsId(String tenantId) {
    return prepareQuery(selectUcSettingsByCredentialsIdQuery(), getUcSettingsTableName(tenantId));
  }

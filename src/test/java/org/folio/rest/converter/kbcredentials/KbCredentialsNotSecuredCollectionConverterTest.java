...
import static org.folio.util.KbCredentialsTestUtil.API_KEY;
...
class KbCredentialsNotSecuredCollectionConverterTest {
  ...
  void shouldConvertKbCredentialsCollectionWithDefaultUrl() {
    ...
    var kbCredentials = nonSecuredConverter.convert(credentialsCollection);
    ...
    assertEquals(API_KEY, credentials.getAttributes().getApiKey());
